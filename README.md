...
Condicionais: Lógica if/elif/else para fornecer feedback em tempo real ao jogador.

Funções: Modularização do código para melhor legibilidade.
...
A cada erro, o programa informa se o número secreto é maior ou menor que o palpite atual.

O jogo encerra ao acertar o número ou esgotar as tentativas.
